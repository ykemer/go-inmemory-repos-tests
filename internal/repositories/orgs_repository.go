...
func (r *OrgsRepository) GetByID(ctx context.Context, id uint) (*models.Organization, error) {
...
func (r *OrgsRepository) Update(ctx context.Context, id uint, data *models.Organization) error {
	return r.db.WithContext(ctx).Model(&models.Organization{}).Where("id = ?", id).Updates(data).Error
}

func (r *OrgsRepository) Delete(ctx context.Context, id uint) error {
