...
func (r *ContractsRepository) ListByOrgId(ctx context.Context, orgId uint) ([]models.Contract, error) {
...
func (r *ContractsRepository) GetByOrgIdAndContractId(ctx context.Context, orgId uint, contractId uint) (*models.Contract, error) {
...
func (r *ContractsRepository) Update(ctx context.Context, id uint, data *models.Contract) error {
	return r.db.WithContext(ctx).Model(&models.Contract{}).Where("id = ?", id).Updates(data).Error
}

func (r *ContractsRepository) Delete(ctx context.Context, id uint) error {
